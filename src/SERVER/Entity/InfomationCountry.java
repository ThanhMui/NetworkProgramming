...
public class InfomationCountry {
	...
	public static void main(String[] args) throws IOException {
		...
		// System.out.println("Country name: "+ getInformation().getContinentName()+ "
		// Population: "+ getInformation().getPopulation());
...
//         }
	...
	public static List<CountryAll> getListInformationCountrys() throws IOException {
		...
		for (CountryAll country : listCountrys) {
			...
			for (String neighbour : neighbours) {
				infomationFullCountrys.add(new CountryAll(country.getName(), country.getPopulation(),
						...
						country.getLanguages(), neighbour));
			}
		}
	...
	public static List<String> getNeighbours(int geonameId) throws IOException {
		String url = "http://api.geonames.org/neighboursJSON?formatted=true&geonameId=" + geonameId
				+ "&username=thanhmui&style=full";
		URL obj;
	...
	public static List<Country> getInformations(String code) throws IOException {
		...
		String url = "http://api.geonames.org/countryInfoJSON?formatted=true&lang=it&username=thanhmui&style=full&country="
				+ code;
		URL obj;
		Country info = null;
		...
		for (CountryAll country : listCountrys) {
			...
			for (GeoName ge : getGeonameIdCountrys) {
				countryAlls.add(new CountryAll(country.getName(), country.getPopulation(), country.getLongtitude(),
						country.getLatitude(), country.getCurrencies(), country.getAlpha2Code(), ge.getGeonameId(),
						ge.getFlag(), ge.getCapital(), ge.getLanguages()));
			}
		}
		return countryAlls;
	}
