...
public class InfomationWheather {
    ...
    public static WeatherCity getWeatherCitys(String cityName) throws IOException{
        ...
        try {
            ...
            JSONObject weather = object.getJSONArray("weather").getJSONObject(0); // trong cai Object co cai mang, trong mang co object thi lay object dau tien ne moi dien 0
